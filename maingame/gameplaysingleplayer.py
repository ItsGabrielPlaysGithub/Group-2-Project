...
ballwav.set_volume(volume * 0.08) # 0.07
scoremp3 = mixer.Sound("gamescore.mp3")
scoremp3.set_volume(volume * 0.1) # 0.09
pause_sound = pygame.mixer.Sound('pause.wav')
pause_sound.set_volume(volume * 0.3) # 0.2
winner_sound = pygame.mixer.Sound('winner.wav')
winner_sound.set_volume(volume * 0.3) # 0.2
pressed = False
...
while gamerun == True:
    ...
    if gameresume == False:
        ...
        scoretext = scorefont.render(scoredisplay, False, (200, 200, 200))
